...
public class FlatMapperExample {
    ...
    public static void main(String[] args) {
        ...
        List<User> users = Arrays.asList(
                ...
                new User("Sam", 40, Arrays.asList("3", "4")),
                new User("Ryan", 60, Arrays.asList("5", "6")),
        ...
        Optional<String> stringOptional = users.stream()
                ...
                .flatMap(stringStream -> stringStream.filter(phoneNo -> phoneNo.equals("1")))
                .findAny();
        stringOptional.ifPresent(phNo -> System.out.println("phNo = " + phNo));
    }
